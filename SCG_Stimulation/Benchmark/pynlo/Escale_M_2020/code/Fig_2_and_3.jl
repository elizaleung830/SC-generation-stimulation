...
@showprogress dt=1 desc="Computing..." for wavelength in wavelength_list
    ...
    LNOI = TensorValue([n_LNOI(wavelength,"o")^2 0 0; 0 n_LNOI(wavelength,"e")^2 0; 0 0 n_LNOI(wavelength,"o")^2])
...
npzwrite("SCG_Stimulation\\Benchmark\\pynlo\\Escale_M_2020\\code\\data_LNOI_y",  Dict("neff_list_tm" => neff_list_tm, "aeff_list_tm" => aeff_list_tm,"neff_list_te" => neff_list_te, "aeff_list_te" => aeff_list_te))
