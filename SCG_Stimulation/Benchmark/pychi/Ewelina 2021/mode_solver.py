...
core_trapiz = Polygon([(width/2 ,0 ),(-width/2 , 0),(-width/2 + triangle_width, triangle_height) , (+width/2-triangle_width, triangle_height)])
core_box = shapely.geometry.box(-(width/2 + triangle_width), -0.2, (width/2 + triangle_width), 0)
