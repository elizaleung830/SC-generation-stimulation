...
core_box = shapely.geometry.box(-(top_width/2 + triangle_width), -0.2, (top_width/2 + triangle_width), 0)
core = unary_union([core_trapiz, core_box])
ridge = shapely.geometry.box(-box_height/2, -slab_height,box_height/2 , 0)
...
##save data
np.savez(f"data_h_{ridge_height}_w_{top_width}_n{ray}", wls=wls, aeff_list_te=aeff_list_te, neff_list_te=neff_list_te, neff_list_tm=neff_list_tm,aeff_list_tm=aeff_list_tm)
